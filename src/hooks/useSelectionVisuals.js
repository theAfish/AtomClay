...
export const useSelectionVisuals = (rendererRef, threeRef, selectedAtomIds, atoms, currentRenderer, visibleAtoms) => {
    useEffect(() => {
    ...
    }, [selectedAtomIds, atoms, currentRenderer, rendererRef, threeRef, visibleAtoms]);
};